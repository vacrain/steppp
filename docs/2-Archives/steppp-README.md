...
gitee上的描述：基于vue3、vite2、naive-ui、TS，目录整洁、开箱即学即用的框架！！
暂时还在研发阶段，会陆续上架web1.0、桌面开发、app、admin、web2.0、web3.0的 布局！！

你可以通过 全注释版，学习自己喜欢的前端技术、设计模式、ts语言的使用等等......

也可以通过 开发版，直接投入使用，直接写业务！......

step by step ，we dev up ~
