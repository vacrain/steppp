...
const { appName } = store.getEndInfo(whichEnd)
...
<template>
  <n-layout has-sider class="app-layout" position="absolute">
    ...
    >
      <n-layout-header bordered>
        ...
        <div>
          <span style="margin-right: 20px" @click="rightThemeDrawerShow = true">{{ t('setUpThemes') }}</span>
          <span style="margin-right: 20px" @click="changeLang">{{ showLang }}</span>
  ...
  <rightThemeDrawer :is-show="rightThemeDrawerShow" @back="rightThemeDrawerShow = false" />
</template>
