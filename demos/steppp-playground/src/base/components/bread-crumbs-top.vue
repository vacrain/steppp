 ...
 * @LastEditTime: 2022-06-02 07:36:02
 * @LastEditors: vacrain
 * @Description: 
 * @FilePath: /steppp-monorepo/apps/quan/src/base/components/bread-crumbs-top.vue
 * 
-->
<!-- 页面顶部面包屑 -->
...
const setBreadInfo = () => {
  breadcrumbInfo.value = JSON.parse(Storage.getSessionItem('breadInfo') as any) || {}
}
const setNowPath = () => {
  nowPath.value = Storage.getSessionItem('nowPath') || breadcrumbInfo.value.path
}
