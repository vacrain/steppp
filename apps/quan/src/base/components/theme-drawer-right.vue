 ...
 * @LastEditTime: 2022-06-02 07:36:08
 * @LastEditors: vacrain
 * @Description: 
 * @FilePath: /steppp-monorepo/apps/quan/src/base/components/theme-drawer-right.vue
 * 
-->
  ...
  <n-drawer :show="isShow" :width="502">
    <n-drawer-content>
      ...
      <template #default>
        ...
        <n-space justify="space-between"> 夜间模式<n-switch v-model:value="darkTheme" :disabled="osTheme" /> </n-space>
        <n-space justify="space-between"> 使用操作系统主题<n-switch v-model:value="osTheme" /> </n-space>
      </template>
      <template #footer>
